...
class AgenteCargosControllerTest < ActionController::TestCase
  ...
  test "should create agente_cargo" do
    assert_difference('AgenteCargo.count') do
      post :create, agente_cargo: { agente_id: @agente_cargo.agente_id, cargo_id: @agente_cargo.cargo_id, descripcion: @agente_cargo.descripcion, establecimiento_id: @agente_cargo.establecimiento_id, estado: @agente_cargo.estado, fecha: @agente_cargo.fecha }
    end
  ...
  test "should update agente_cargo" do
    put :update, id: @agente_cargo, agente_cargo: { agente_id: @agente_cargo.agente_id, cargo_id: @agente_cargo.cargo_id, descripcion: @agente_cargo.descripcion, establecimiento_id: @agente_cargo.establecimiento_id, estado: @agente_cargo.estado, fecha: @agente_cargo.fecha }
    assert_redirected_to agente_cargo_path(assigns(:agente_cargo))
  end
