class CargosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @cargo.save
        format.html { redirect_to @cargo, notice: 'Se ha creado un nuevo cargo.' }
  ...
  def update
    ...
    respond_to do |format|
      if @cargo.update_attributes(params[:cargo])
        format.html { redirect_to @cargo, notice: 'El Cargo ha sido editado correctamente.' }
  ...
  def actualizar_indice
    nuevo_indice = params[:nuevo_indice]    
    @cargos = Cargo.all
    @cargos.each do |c|
      c.actualizar_indice nuevo_indice
    end
    respond_to do |format|
      format.html { redirect_to cargos_url}
      format.json { head :no_content }
